...
namespace KitchenSink.Extensions
{
    ...
    public static class TypeExtensions
    {
        ...
        /// </summary>
        public static bool IsAssignableTo(this Type x, Type y) => y.IsAssignableFrom(x);

        /// <summary>
        /// Attempts to get instance of <see cref="Attribute"/> from type declaration.
        /// </summary>
        public static Maybe<A> GetAttribute<A>(this Type type) where A : Attribute => type.GetCustomAttribute<A>();
        ...
        public static Maybe<A> GetAttribute<A>(this Type type, Func<A, bool> predicate) where A : Attribute =>
            type.GetCustomAttributes<A>().FirstMaybe(predicate);

        /// <summary>
        /// Returns true if the attribute <c>A</c> is defined on the given type.
        /// </summary>
        public static bool HasAttribute<A>(this Type type) where A : Attribute => type.GetAttribute<A>().HasValue;
        ...
        public static bool HasAttribute<A>(this Type type, Func<A, bool> predicate) where A : Attribute =>
            type.GetAttribute(predicate).HasValue;
    }
}
