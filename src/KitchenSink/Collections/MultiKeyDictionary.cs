...
namespace KitchenSink.Collections
{
    ...
    public class Dictionary<TKey1, TKey2, TValue> : Dictionary<(TKey1, TKey2), TValue>
    {
        ...
        public bool ContainsKeys(TKey1 a, TKey2 b) => ContainsKey((a, b));

        public bool ContainsKey1(TKey1 a) => Keys.Any(x => Equals(x.Item1, a));
        public bool ContainsKey2(TKey2 b) => Keys.Any(x => Equals(x.Item2, b));
        ...
        public void Add(TKey1 a, TKey2 b, TValue value) => Add((a, b), value);

        public bool Remove(TKey1 a, TKey2 b) => Remove((a, b));

        public bool TryGetValue(TKey1 a, TKey2 b, out TValue value) => TryGetValue((a, b), out value);
    ...
    public class Dictionary<TKey1, TKey2, TKey3, TValue> : Dictionary<(TKey1, TKey2, TKey3), TValue>
    {
        ...
        public bool ContainsKeys(TKey1 a, TKey2 b, TKey3 c) => ContainsKey((a, b, c));

        public bool ContainsKey1(TKey1 a) => Keys.Any(x => Equals(x.Item1, a));
        public bool ContainsKey2(TKey2 b) => Keys.Any(x => Equals(x.Item2, b));
        public bool ContainsKey3(TKey3 c) => Keys.Any(x => Equals(x.Item3, c));

        public ICollection<TKey1> Keys1 => Keys.Select(x => x.Item1).Distinct().ToList();
        public ICollection<TKey2> Keys2 => Keys.Select(x => x.Item2).Distinct().ToList();
        public ICollection<TKey3> Keys3 => Keys.Select(x => x.Item3).Distinct().ToList();

        public void Add(TKey1 a, TKey2 b, TKey3 c, TValue value) => Add((a, b, c), value);

        public bool Remove(TKey1 a, TKey2 b, TKey3 c) => Remove((a, b, c));

        public bool TryGetValue(TKey1 a, TKey2 b, TKey3 c, out TValue value) =>
            TryGetValue((a, b, c), out value);
    ...
    public class Dictionary<TKey1, TKey2, TKey3, TKey4, TValue> : Dictionary<(TKey1, TKey2, TKey3, TKey4), TValue>
    {
        ...
        public bool ContainsKeys(TKey1 a, TKey2 b, TKey3 c, TKey4 d) => ContainsKey((a, b, c, d));

        public bool ContainsKey1(TKey1 a) => Keys.Any(x => Equals(x.Item1, a));
        public bool ContainsKey2(TKey2 b) => Keys.Any(x => Equals(x.Item2, b));
        public bool ContainsKey3(TKey3 c) => Keys.Any(x => Equals(x.Item3, c));
        public bool ContainsKey4(TKey4 d) => Keys.Any(x => Equals(x.Item2, d));
        ...
        public void Add(TKey1 a, TKey2 b, TKey3 c, TKey4 d, TValue value) => Add((a, b, c, d), value);

        public bool Remove(TKey1 a, TKey2 b, TKey3 c, TKey4 d) => Remove((a, b, c, d));

        public bool TryGetValue(TKey1 a, TKey2 b, TKey3 c, TKey4 d, out TValue value) =>
            TryGetValue((a, b, c, d), out value);
